...
(function () {
  ...
  // 初始就拥有的图鉴条目（直接按名称作为 key；“无”不计入图鉴）
  ...
  const ACHIEVEMENTS = [
    // 专注类 —— 基础
    {
      id: "focus_first_task",
      category: "专注类",
      logicKey: "focus_first_task",
      name: "第一滴经验",
      description: "冒险很好的开始。",
      condition: "至少完成 1 个任务。",
      rewardText: "金币 +10",
    },
    {
      id: "focus_streak_3",
      category: "专注类",
      logicKey: "focus_streak_3",
      name: "不见不散",
      description: "三天都记得回来，说明这次你是认真的。",
      condition: "连续打卡 3 天。",
      rewardText: "金币 +30",
    },
    {
      id: "focus_pomodoro_1",
      category: "专注类",
      logicKey: "focus_pomodoro_1",
      name: "善用工具",
      description: "番茄钟，你的好伙伴。",
      condition: "第一次使用番茄钟。",
      rewardText: "金币 +40",
    },
    // 专注类 —— 扩展
    {
      id: "focus_tasks_10",
      category: "专注类",
      logicKey: "focus_tasks_10",
      name: "十连胜",
      description: "十次按下「完成」之后，列表安静了一小会儿。",
    ...
    },
    {
      id: "focus_tasks_50",
      category: "专注类",
      logicKey: "focus_tasks_50",
      name: "专注大师",
      description: "你在待办栏上画了好多好多小钩子。",
    ...
    },
    {
      id: "focus_streak_7",
      category: "专注类",
      logicKey: "focus_streak_7",
      name: "一周都记得来",
      description: "连续一整周，你每天都和这个小世界打了个招呼。",
      condition: "连续打卡 7 天。",
      rewardText: "金币 +80",
    },
    ...
    // 等级成就
    {
      ...
      logicKey: "level_2",
      name: "冒险刚起步",
      description: "从 Lv.1 升到 Lv.2，小人正式踏出新手村门口。",
      condition: "角色等级达到 Lv.2。",
      rewardText: "金币 +20",
    },
    {
      id: "level_5",
      ...
      logicKey: "level_5",
      name: "新手出村",
      description: "等级爬到 5 级，已经不是刚出生的小白板了。",
      condition: "角色等级达到 Lv.5。",
      rewardText: "金币 +50",
    },
    {
      id: "level_10",
      ...
      logicKey: "level_10",
      name: "小镇名人",
      description: "等级来到两位数，附近的怪物开始记住你的名字。",
      condition: "角色等级达到 Lv.10。",
      rewardText: "金币 +120",
    },
    {
      id: "level_20",
      ...
      logicKey: "level_20",
      name: "冒险老手",
      description: "走过二十级的长路，你已经是这个像素世界的老熟人了。",
      condition: "角色等级达到 Lv.20。",
      rewardText: "金币 +260",
    },

    // 收集类 —— 基础
    {
      id: "collection_first_gear",
      category: "收集类",
      logicKey: "collection_first_gear",
      name: "买买买",
      description: "从此以后，你不再是空手上路的新人。",
      condition: "在商店购买 3 件物品。",
      rewardText: "金币 +30",
    },
    {
      id: "collection_codex_5",
      category: "收集类",
      logicKey: "collection_codex_5",
      name: "收集爱好者",
      description: "贴纸越攒越多，冒险故事也开始有章节感了。",
      condition: "解锁图鉴条目总数达到 5 个。",
      rewardText: "金币 +60",
    },
    {
      id: "collection_gold_500",
      category: "收集类",
      logicKey: "collection_gold_500",
      name: "小有积蓄",
      description: "钱包不再只能发出铜币声，开始有点底气了。",
      condition: "金币数量达到 500。",
      rewardText: "金币 +80",
    },

    // 收集类 —— 扩展
    {
      id: "collection_gold_1000",
      category: "收集类",
      logicKey: "collection_gold_1000",
      name: "小有盈余",
      description: "钱包里第一次出现了四位数的金币。",
      condition: "金币数量达到 1000。",
      rewardText: "金币 +120",
    },
    {
      id: "collection_gold_2000",
      category: "收集类",
      logicKey: "collection_gold_2000",
      name: "金币真香",
      description: "金币堆得有点高了，可以考虑掏空商店。",
      condition: "金币数量达到 2000。",
      rewardText: "金币 +200",
    },
    {
      id: "collection_codex_10",
      category: "收集类",
      logicKey: "collection_codex_10",
      name: "集齐第一面",
      description: "你的冒险相册逐渐丰富起来。",
      condition: "解锁图鉴条目总数达到 10 个。",
      rewardText: "金币 +80",
    },
    {
      id: "collection_codex_30",
      category: "收集类",
      logicKey: "collection_codex_30",
      name: "图鉴爱好者",
      description: "再添几张贴纸，就要把这本图鉴贴满了。",
      condition: "解锁图鉴条目总数达到 30 个。",
      rewardText: "金币 +160",
    },
    {
      id: "collection_codex_50",
      category: "收集类",
      logicKey: "collection_codex_50",
      name: "图鉴收藏家",
      description: "你几乎认识了这个小世界里的所有角落。",
      condition: "解锁图鉴条目总数达到 50 个。",
      rewardText: "金币 +260",
    },
    {
      id: "collection_pet_3",
      category: "收集类",
      logicKey: "collection_pet_3",
      name: "小队成形",
      description: "身边已经有一支三人（兽）小队陪你冒险。",
      condition: "拥有 3 只已孵化的宠物。",
      rewardText: "金币 +120",
    },

    // 冒险类 —— 基础
    {
      id: "adventure_first_trip",
      category: "冒险类",
      logicKey: "adventure_first_trip",
      name: "迈出第一步",
      description: "不再只是在营地里画地图，而是真的走了出去。",
      condition: "至少成功完成 1 次冒险。",
      rewardText: "金币 +20",
    },
    {
      id: "adventure_first_boss",
      category: "冒险类",
      logicKey: "adventure_first_boss",
      name: "首战告捷",
      description: "我可以战胜我自己！",
      condition: "击败 1 个 Boss。",
      rewardText: "金币 +30",
    },
    {
      id: "adventure_pet_hatched",
      category: "冒险类",
      logicKey: "adventure_pet_hatched",
      name: "第一个伙伴",
      description: "蛋壳里蹦出来的，不只是宠物，也是你的同行者。",
      condition: "成功孵化 1 个宠物。",
      rewardText: "金币 +50",
    },

    // 冒险类 —— 扩展
    {
      id: "adventure_trips_5",
      category: "冒险类",
      logicKey: "adventure_trips_5",
      name: "五次短途",
      description: "你已经熟悉了从营地出发再回来这条路。",
      condition: "成功完成 5 次冒险。",
      rewardText: "金币 +60",
    },
    {
      id: "adventure_trips_20",
      category: "冒险类",
      logicKey: "adventure_trips_20",
      name: "熟门熟路",
      description: "营地附近的每块石头，你大概都见过很多次了。",
      condition: "成功完成 20 次冒险。",
      rewardText: "金币 +180",
    },
    {
      id: "adventure_slots_max",
      category: "冒险类",
      logicKey: "adventure_slots_max",
      name: "背包塞满勇气",
      description: "冒险槽拉满的时候，看什么路都觉得能走。",
      condition: "当前冒险槽达到上限值。",
      rewardText: "金币 +80",
    },
    {
      id: "adventure_all_locations_once",
      category: "冒险类",
      logicKey: "adventure_all_locations_once",
      name: "这一片我熟",
      description: "在同一个地点来来回回，总算摸熟了这条路。",
      condition: "在任意一个冒险地点成功完成 5 次冒险。",
      rewardText: "金币 +240",
    },
    {
      id: "adventure_pet_adult",
      category: "冒险类",
      logicKey: "adventure_pet_adult",
      name: "一路养到成年",
      description: "从一颗小蛋到成年伙伴，你们一起走完了成长条。",
      condition: "至少有一只宠物从幼年成长为成年阶段。",
      rewardText: "金币 +150",
    },

    // 其他 —— 基础
    {
      id: "misc_customize_avatar",
      category: "其他",
      logicKey: "misc_customize_avatar",
      name: "这是我自己",
      description: "屏幕上的像素人，终于和镜子里的那个人有点像了。",
      condition: "至少修改过一次角色外观。",
      rewardText: "金币 +20",
    },
    {
      id: "misc_theme_switch",
      category: "其他",
      logicKey: "misc_theme_switch",
      name: "换个颜色换个心情",
      description: "当背景颜色变了，今天的心情也跟着刷新了一下。",
      condition: "至少成功切换过 1 次界面主题。",
      rewardText: "金币 +20",
    },
    {
      id: "misc_daily_signin_7",
      category: "其他",
      logicKey: "misc_daily_signin_7",
      name: "一周都没落下",
      description: "七个小格子都被点亮，这一周你和生活保持了连接。",
      condition: "累计完成 7 天每日签到（不要求连续）。",
      rewardText: "金币 +100",
    },
    ...
    // 其他 —— 扩展
    {
      id: "misc_export_save",
      category: "其他",
      logicKey: "misc_export_save",
      name: "安全意识",
      description: "你认真地把这段冒险打包存档了一次。",
      condition: "至少成功导出过 1 次存档。",
      rewardText: "金币 +40",
    },
    {
      id: "misc_import_save",
      category: "其他",
      logicKey: "misc_import_save",
      name: "异世界迁移",
      description: "你从另一个存档里把冒险人生搬了过来。",
      condition: "至少成功导入过 1 次存档。",
      rewardText: "金币 +60",
    },
    {
      id: "misc_reset_once",
      category: "其他",
      logicKey: "misc_reset_once",
      name: "重开人生",
      description: "漫漫人生路，愿你我都有重新开始的勇气。",
      condition: "至少执行过 1 次数据初始化。",
      rewardText: "金币 +80",
    },
    {
      id: "misc_logs_20",
      category: "其他",
      logicKey: "misc_logs_20",
      name: "冒险日记本",
      description: "日志里已经躺着二十条形形色色的小事。",
      condition: "日志条目累计达到 20 条。",
      rewardText: "金币 +60",
    }
  ];
  ...
  const REST_OPTIONS = [
    { id: "rest-nap", name: "摸鱼时刻", price: 22, hp: 18, exp: 4, description: "恢复一点体力和灵感。" },
    { id: "rest-break", name: "认真休息", price: 45, hp: 38, exp: 8, description: "适合做完一轮任务后缓一缓。" },
    { id: "rest-chill", name: "豪华摆烂", price: 85, hp: 68, exp: 14, description: "花更多金币，恢复更多生命与经验。" },
  ];
  ...
  const PET_CARE_OPTIONS = [
    { id: "pet-pat", name: "抚摸", price: 8, growth: 16, icon: "pat" },
    { id: "pet-feed", name: "喂食", price: 18, growth: 40, icon: "feed" },
    { id: "pet-potion", name: "喂成长药水", price: 34, growth: 84, icon: "potion" },
  ];
  ...
  const ACCESSORY_PIXEL_MASKS = {
    ...
    "金色王冠": [[11, 0, 10, 4]], "月光王冠": [[11, 0, 10, 4]], "黄铜王冠": [[11, 0, 10, 4]],
  ...
  function unlockCodexEntry(kind, rawKey, name, origin) {
    ...
    if (firstUnlock) {
      ...
      if (unlockedCount >= 5) unlockAchievement("collection_codex_5");
    }
  }
  ...
  function createTask(title, bucket, difficulty, completedToday, completed) {
    return {
      id: uid("task"),
      title: title,
      bucket: bucket,
  ...
  function normalizeState(input) {
    ...
    // 确保已拥有装备中始终包含“无”（空手选项），同时保留存档里的已有装备
    if (!stateValue.collection.weapons || !stateValue.collection.weapons.length) stateValue.collection.weapons = ["无", "木剑"];
    else if (stateValue.collection.weapons.indexOf("无") < 0) stateValue.collection.weapons.unshift("无");
    if (!stateValue.profile.appearance.weapon || stateValue.collection.weapons.indexOf(stateValue.profile.appearance.weapon) < 0) stateValue.profile.appearance.weapon = "无";
  ...
  function equipCatalogItem(item) {
    ...
    if (item.category === "accessory") {
      const list = currentAccessories(state.profile.appearance);
      const v = item.unlockValue;
      if (list.indexOf(v) >= 0) return;
      if (list.length >= MAX_ACCESSORIES) return;
      if (accessoryOverlapsWithList(v, list)) return;
  ...
  function showTreasure(title, subtitle) {
    setModal({
      ...
      rewardLabel: title,
      subtitle: subtitle,
      rewards: [{ label: title, detail: subtitle }]
    });
  }

  function activeAchievements() {
    if (!state.achievements || typeof state.achievements !== "object") state.achievements = { unlocked: {}, recentIds: [] };
    if (!state.achievements.unlocked) state.achievements.unlocked = {};
    if (!Array.isArray(state.achievements.recentIds)) state.achievements.recentIds = [];
  ...
  function unlockAchievement(id) {
    ...
    if (ach) {
      queueToast("解锁成就：「" + ach.name + "」", "success");
    }
  }
  ...
  function completeTask(taskId, fromPomodoro) {
    ...
    if (state.lastCompletionDay !== todayKey) {
      ...
      if (state.lastCompletionDay === yesterdayKey) state.profile.streak += 1;
  ...
  function recoverWith(optionId) {
    ...
    healHp(option.hp);
    const gainedExp = addExp(option.exp);
    addLog("你选择了“" + option.name + "”，恢复 " + option.hp + " HP 和 " + gainedExp + " EXP。");
  ...
  function purchaseCatalog(itemId) {
    ...
    if ((state.shopPurchases || 0) >= 3) unlockAchievement("collection_first_gear");
    saveState();
    renderApp();
  }
  ...
  function flappyCoinMultiplierForLocation(location) {
    // 示例：薄雾草甸 10 倍、午后街角 11 倍……按场景稀有度递增
  ...
  function flappyPipePaletteForLocation(location) {
    // 每个场景生成一套唯一配色（保证不同场景柱子颜色不重复）
    const id = String(location && location.id ? location.id : "default");
    let h = 0;
  ...
  function settleAdventureTrip(trip, options) {
    ...
    if (reward.type === "gold") {
      ...
      if (settings.toastOnly) {
        ...
        showTreasure(reward.gold + " \u91d1\u5e01", "\u8fd9\u6b21\u5192\u9669\u4e3b\u8981\u5e26\u56de\u4e86\u91d1\u5e01\u5956\u52b1\u3002");
      }
      ...
      if (granted) {
        ...
        else showTreasure(granted.label, granted.subtitle);
      } else if (!settings.toastOnly) {
        // 极少数情况下（例如找不到物品）退回金币奖励
        const fallbackGold = reward.gold || 24;
        addGold(fallbackGold);
        showTreasure(fallbackGold + " \u91d1\u5e01", "\u672a\u627e\u5230\u526f\u4f1a\u6389\u843d\u7684\u9053\u5177\uff0c\u8f6c\u800c\u83b7\u5f97\u91d1\u5e01\u5956\u52b1\u3002");
      }
    } else {
      // 理论上不会走到这里，兜底给一点金币
      ...
      else showTreasure(fallbackGold + " \u91d1\u5e01", "\u8fd9\u6b21\u5192\u9669\u4e3b\u8981\u5e26\u56de\u4e86\u91d1\u5e01\u5956\u52b1\u3002");
    }
    state.adventure.activeTrip = null;
    return true;
  }
  ...
  function equipAppearanceFromCollection(key, value) {
    if (key === "accessory") {
      ...
      } else if (list.length >= MAX_ACCESSORIES) {
        setToast("最多佩戴 " + MAX_ACCESSORIES + " 个配饰。", "info");
        return;
      } else if (accessoryOverlapsWithList(value, list)) {
        setToast("与已佩戴的配饰像素重合，无法同时佩戴。", "info");
        return;
      } else {
  ...
  document.addEventListener("keydown", function (event) {
    ...
    // Flappy 小游戏快捷键
    if (state.modal && state.modal.type === "flappy") {
      const isSpace = event.code === "Space" || event.key === " " || event.key === "Spacebar" || event.key === "Space";
      if (isSpace) {
        event.preventDefault();
        // 空格：开始/起跳。若还没选难度，提示先选择。
        if (state.modal.phase === "select" || !state.modal.tierId) {
          setToast("先选择目标难度，再按空格开始。", "info");
          renderApp();
          return;
        }
        // 在 ready / over 阶段：请求开始；在 playing 阶段：起跳
        if (state.modal.phase !== "playing") state.modal._startRequested = true;
        state.modal._flapRequested = true;
        renderApp();
        return;
      }
      if (event.key === "Enter") {
        // Enter：回到准备态（下一次空格再开始并扣槽）
        if (state.modal.tierId) state.modal.phase = "ready";
        else state.modal.phase = "select";
        state.modal.spentSlotsThisRun = false;
        state.modal.score = 0;
        state.modal.coinCount = 0;
        state.modal.pipes = [];
        state.modal.birdV = 0;
        renderApp();
        return;
  ...
  function drawButton(targetCtx, x, y, width, height, label, variant, options) {
    ...
    const labelSize = fitPixelTextSize(label, width - 18, height - 12, baseSize, 9, { color: config.text, font: "sans-serif" });
    const sprite = getTextSprite(String(label), { size: labelSize, color: config.text, font: "sans-serif" });
    targetCtx.drawImage(sprite, Math.round(x + (width - sprite.width) / 2), Math.round(y + (height - sprite.height) / 2));
  }
  ...
  function drawMeter(targetCtx, x, y, width, value, max, colors, label) {
    ...
    while (textSize > 10) {
      labelSprite = getTextSprite(String(label), { size: textSize, color: THEME.inkSoft, font: "sans-serif" });
      valueSprite = getTextSprite(String(valueText), { size: textSize, color: THEME.inkSoft, font: "sans-serif" });
      if (labelSprite.width + valueSprite.width + 18 <= width) break;
      textSize -= 1;
    }
    drawPixelText(targetCtx, label, x, y - 28, { size: textSize, color: THEME.inkSoft, font: "sans-serif" });
    drawPixelText(targetCtx, valueText, x + width, y - 28, { size: textSize, color: THEME.inkSoft, font: "sans-serif", align: "right" });
  ...
  function drawStatBox(targetCtx, x, y, width, height, label, value) {
    ...
    drawPixelText(targetCtx, label, x + 16, y + 14, { size: 11, color: THEME.inkSoft, font: "sans-serif" });
    const valueText = String(value);
    const fittedSize = fitCanvasTextSize(valueText, width - 34, 28, "700", 16);
    const valueY = y + Math.max(34, Math.round(height * 0.48) - Math.round(fittedSize * 0.18));
    drawText(targetCtx, valueText, x + 18, valueY, fittedSize, THEME.ink, "700");
  }

  function drawSectionHeader(targetCtx, x, y, small, title) {
    drawTextFitted(targetCtx, small, x, y, 360, 14, THEME.inkSoft, "500", "left", 11);
    drawTextFitted(targetCtx, title, x, y + 22, 700, 30, THEME.ink, "700", "left", 18);
  }
  ...
  function drawCharacterPixels(sctx, appearance, size) {
    ...
    if (acc.includes("金色王冠") || acc.includes("月光王冠") || acc.includes("黄铜王冠")) {
      ...
      fillRect(sctx, 11 * unit, 2 * unit, 10 * unit, 2 * unit, band);
      fillRect(sctx, 12 * unit, 1 * unit, 2 * unit, 2 * unit, topGem);
      fillRect(sctx, 15 * unit, 0 * unit, 2 * unit, 3 * unit, crownPeak);
      fillRect(sctx, 18 * unit, 1 * unit, 2 * unit, 2 * unit, crownPeakShade);
      fillRect(sctx, 12 * unit, 3 * unit, 8 * unit, 1 * unit, bandDark);
      fillRect(sctx, 13 * unit, 2 * unit, 1 * unit, 1 * unit, bandHighlight);
      fillRect(sctx, 16 * unit, 1 * unit, 1 * unit, 1 * unit, smallHighlight);
      fillRect(sctx, 18 * unit, 2 * unit, 1 * unit, 1 * unit, sideGem);
    }
    ...
    if (!appearance.weapon || appearance.weapon === "无") {
      ...
      fillRect(sctx, 22 * unit, 18 * unit, 4 * unit, 6 * unit, "#6b58d8");
...
function getTreasureSprite(size) {
  ...
  function renderDashboard(targetCtx, view, y) {
    ...
    drawTextFitted(targetCtx, heroName, profileTextX, profileRect.y + 94, profileTextW, 30, profileLight, "700", "left", 18);
    drawTextFitted(targetCtx, "Lv." + state.profile.level, profileTextX, profileRect.y + 142, profileTextW, 18, profileSoft, "600", "left", 14);
    drawTextFitted(targetCtx, roleSubtitle(state.profile.level), profileTextX, profileRect.y + 178, profileTextW, 28, profileLight, "700", "left", 18);
    ...
    const moodBaseY = metersRect.y + 192;
    ...
    drawMeter(targetCtx, bossTextX, bossRect.y + 205, bossRect.w - (bossTextX - bossRect.x) - 34, boss.hp, boss.maxHp, [THEME.bossA, THEME.bossB], "BOSS HP");
    drawParagraph(targetCtx, boss.tip, bossTextX, bossRect.y + 254, bossTextWidth, 15, THEME.inkSoft, 21, { maxLines: 2 });
  ...
  function renderNav(targetCtx, view, y) {
    ...
    if (!rowBreak) {
      ...
      tabs.forEach(function (tab, index) {
        ...
        drawButton(targetCtx, x, y + 20, buttonW, 56, tab[1], disabled ? "disabled" : (state.page === tab[0] ? "yellow" : "paper"), { active: !disabled && state.page === tab[0], disabled: disabled });
      ...
      tabs.forEach(function (tab, index) {
        ...
        const disabled = state.pureMode && tab[0] !== "tasks";
        drawButton(targetCtx, x, yPos, width, 48, tab[1], disabled ? "disabled" : (state.page === tab[0] ? "yellow" : "paper"), { active: !disabled && state.page === tab[0], small: true, disabled: disabled });
  ...
  function bucketSectionHeight(taskCount) {
    return taskCount > 0 ? 84 + taskCount * 206 : 196;
  }
  ...
  function renderTaskCard(targetCtx, x, y, width, task) {
    ...
    drawText(targetCtx, diff.label + "  /  +" + diff.exp + " EXP  /  +" + diff.gold + " 金币  /  -" + diff.hpCost + " HP", x + 24, y + 90, 20, THEME.inkSoft, "500");
    ...
    drawButton(targetCtx, x + 18, y + 126, buttonWidth, 48, completeLabel, "green", { small: true, disabled: disableComplete });
    drawButton(targetCtx, x + 18 + buttonWidth + 18, y + 126, buttonWidth, 48, "番茄", "yellow", { small: true, disabled: disableComplete });
  ...
  function renderBucketSection(targetCtx, x, y, width, title, subtitle, tasks, options) {
    ...
    if (sectionOptions.actionLabel && sectionOptions.onAction) {
      const actionWidth = 172;
      drawButton(targetCtx, x + width - actionWidth, y + 18, actionWidth, 44, sectionOptions.actionLabel, sectionOptions.actionVariant || "paper", { small: true });
      registerRegion(mainRegions, x + width - actionWidth, y + 18, actionWidth, 44, sectionOptions.onAction);
    }
    let cursorY = y + 88;
    if (tasks.length === 0) {
  ...
  function renderRewards(targetCtx, x, y, width) {
    ...
    let cursor = y + 112;
    if (!hasRewards) {
      drawCard(targetCtx, x + 28, cursor, width - 56, 72, THEME.paper);
      drawText(targetCtx, "这里还没有奖励，注意劳逸结合哦", x + width / 2, cursor + 22, 22, THEME.inkSoft, "500", "center");
      return y + sectionHeight;
    }
    state.rewards.forEach(function (reward) {
      const cardW = width - 56;
      const nameRegionW = cardW - 48 - 260;
      drawCard(targetCtx, x + 28, cursor, cardW, cardHeight, THEME.paper);
      drawText(targetCtx, reward.name, x + 48, cursor + 26, 28, THEME.ink, "700");
      registerRegion(mainRegions, x + 48, cursor + 26, Math.max(100, nameRegionW), 32, function () {}, { tooltip: "双击来修改名称", regionKey: "reward-" + reward.id, onDblClick: function () { openRenameReward(reward.id); } });
      drawText(targetCtx, reward.price + " 金币", x + 48, cursor + 82, 20, THEME.inkSoft, "500");
      const enough = state.profile.gold >= reward.price;
      drawButton(targetCtx, x + width - 260, cursor + 24, 96, 68, enough ? "兑换" : "不够钱", enough ? "yellow" : "disabled");
      drawButton(targetCtx, x + width - 152, cursor + 24, 96, 68, "删除", "red");
      if (enough) registerRegion(mainRegions, x + width - 260, cursor + 24, 96, 68, function () { exchangeReward(reward.id); });
      registerRegion(mainRegions, x + width - 152, cursor + 24, 96, 68, function () { deleteReward(reward.id); });
  ...
  function renderRest(targetCtx, x, y, width) {
    ...
    REST_OPTIONS.forEach(function (option) {
      ...
      drawText(targetCtx, "恢复 " + option.hp + " HP 与 " + option.exp + " EXP。 " + option.description, x + 48, cursor + 82, 20, THEME.inkSoft, "500");
  ...
  function renderTasksPage(targetCtx, view, y) {
    ...
    const visibleTodo = state.showCompletedTodo ? groups.todo : groups.todo.filter(function (task) { return !task.completed; });
    const hiddenCompletedCount = groups.todo.length - visibleTodo.length;
    const sectionHeight = 86 + bucketSectionHeight(visibleTodo.length) + 16 + bucketSectionHeight(groups.habit.length) + 16 + bucketSectionHeight(groups.learn.length) + 40;
    drawPanel(targetCtx, x, y, w, sectionHeight, THEME.paper);
    drawSectionHeader(targetCtx, x + 30, y + 30, "任务区", "挑战列表");
    let cursor = y + 110;
    cursor = renderBucketSection(targetCtx, x + 30, cursor, w - 60, "To do", "待办事项", visibleTodo, {
      actionLabel: state.showCompletedTodo ? "隐藏已完成" : "显示已完成",
      actionVariant: "paper",
      onAction: function () {
    ...
    cursor = renderBucketSection(targetCtx, x + 30, cursor + 16, w - 60, "Learn", "技能学习", groups.learn);
  ...
  function renderShopPage(targetCtx, view, y) {
    ...
    const sectionHeight = 244 + items.length * 168;
    drawPanel(targetCtx, x, y, w, sectionHeight, THEME.paper);
    ...
    categories.forEach(function (entry) {
      ...
      drawButton(targetCtx, tabX, tabY + 10, btnW, 58, entry[1], disabled ? "disabled" : (state.shopCategory === entry[0] ? "yellow" : "paper"), { small: true, active: !disabled && state.shopCategory === entry[0], disabled: disabled });
    ...
    items.forEach(function (item) {
      ...
      drawSpriteFrame(targetCtx, getCatalogPreview(item, 48), x + 46, cursor + 22, 118, itemRarityFrameColor(item));
      drawText(targetCtx, CATEGORY_LABELS[item.category] + "  •  " + itemRarityLabel(item), x + 186, cursor + 22, 24, THEME.inkSoft, "500");
      ...
      if (isEquippedCatalogItem(item)) label = item.category === "petEgg" ? "\u57f9\u517b\u4e2d" : "\u5df2\u88c5\u5907";
  ...
  function renderPetsPage(targetCtx, view, y) {
    ...
    const topCardHeight = !hasPets ? 226 : 348;
    ...
    drawTextFitted(targetCtx, petDisplayName(pet), x + 288, y + 160, w - 390, 28, THEME.ink, "700", "left", 18);
    drawTextFitted(targetCtx, "阶段：" + petStageLabel(pet) + "  •  来源：" + pet.source + "  •  等级：" + petRarityLabel(pet), x + 288, y + 208, w - 390, 18, THEME.inkSoft, "700", "left", 13);
    if (pet.isEgg) {
      ...
      drawParagraph(targetCtx, pet.incubationStartedAt ? "孵化已经开始了，耐心等它破壳吧。剩余约 " + remainingMinutes + " 分钟。" : "这颗蛋需要 " + totalMinutes + " 分钟完成孵化。点击开始后等待即可，也能直接金币加速。", x + 288, y + 244, w - 390, 18, THEME.inkSoft, 22, { maxLines: 3 });
      drawMeter(targetCtx, x + 288, y + 320, Math.min(420, w - 390), progressValue, totalMinutes, [THEME.expA, THEME.expB], "孵化进度");
      drawButton(targetCtx, x + 288, y + 362, 178, 62, pet.incubationStartedAt ? "孵化中" : "开始孵化", pet.incubationStartedAt ? "disabled" : "green", { small: true, disabled: Boolean(pet.incubationStartedAt) });
      const hatchPrice = petInstantHatchCost(pet);
      drawButton(targetCtx, x + 482, y + 362, 214, 62, "一键孵化（" + hatchPrice + "）", state.profile.gold >= hatchPrice ? "yellow" : "disabled", { small: true, disabled: state.profile.gold < hatchPrice });
      if (!pet.incubationStartedAt) registerRegion(mainRegions, x + 288, y + 362, 178, 62, startPetIncubation);
      if (state.profile.gold >= hatchPrice) registerRegion(mainRegions, x + 482, y + 362, 214, 62, instantHatchPet);
    } else {
      ...
      if (showDisplaySelector) {
        const selectorY = y + 244;
        drawText(targetCtx, "展示形态", x + 288, selectorY, 18, THEME.inkSoft, "500");
        ...
        options.forEach(function (option) {
          ...
          drawButton(targetCtx, chipX, selectorY + 28, chipW, 46, label, active ? "green" : "paper", { small: true, active: active, disabled: active });
          if (!active) registerRegion(mainRegions, chipX, selectorY + 28, chipW, 46, function () { setCurrentPetDisplayForm(option); });
          chipX += chipW + 12;
        });
        descY += 86;
        meterY += 86;
      ...
      const barsWidth = 300;
      const barsGap = 10;
      const descMeterWidth = Math.max(240, Math.min(420, w - 288 - 24 - barsWidth - 56));
      const barsLeft = x + 288 + descMeterWidth + 40;
      const barsWidthActual = Math.min(barsWidth, w - 28 - (barsLeft - x) - 28);
      drawParagraph(targetCtx, pet.stage >= PET_STAGES.length - 1 ? "它已经成长为完全体啦，可以继续陪你一起冒险。" : "抚摸、喂食或成长药水都能推动成长条，越贵效果越强。", x + 288, descY, descMeterWidth, 18, THEME.inkSoft, 22, { maxLines: 3 });
      drawMeter(targetCtx, x + 288, meterY, descMeterWidth, growthValue, Math.max(1, growthNeed), [THEME.hpA, THEME.hpB], "成长条");
      if (pet.stage < PET_STAGES.length - 1) {
  ...
  function renderAdventurePage(targetCtx, view, y) {
    ...
    const sectionHeight = 184 + rows * 232 + 310;
    drawPanel(targetCtx, x, y, w, sectionHeight, THEME.paper);
    drawSectionHeader(targetCtx, x + 30, y + 30, "探索地图", "冒险区域");
    const progressY = y + 96;
    const locationsTopY = progressY + 254 + 24;
    ADVENTURE_LOCATIONS.forEach(function (location, index) {
      const row = Math.floor(index / columns);
      const col = index % columns;
      const cardX = x + 28 + col * (cardW + 20);
      const cardY = locationsTopY + row * 232;
      const buttonX = cardX + cardW - 262;
      const textWidth = Math.max(160, buttonX - (cardX + 176) - 28);
      drawCard(targetCtx, cardX, cardY, cardW, 214, THEME.paper);
      drawSpriteFrame(targetCtx, getSceneSprite(location.scene, 48), cardX + 22, cardY + 20, 130);
      drawTextFitted(targetCtx, location.name, cardX + 176, cardY + 22, textWidth, 24, THEME.ink, "700", "left", 18);
      drawParagraph(targetCtx, "消耗 " + location.cost + " 冒险槽，耗时 " + location.minutes + " 分钟，" + location.desc, cardX + 176, cardY + 64, textWidth, 16, THEME.inkSoft, 24, { maxLines: 4 });
      const trip = currentAdventureTrip();
      const unlockLevel = Math.max(1, Number(location.unlockLevel) || 1);
      ...
      // 出发按钮缩小，为小游戏按钮腾出空间
      drawButton(targetCtx, buttonX, cardY + 52, 218, 56, buttonLabel, canGo ? "paper" : "disabled", { small: true, disabled: !canGo });
      if (canGo) registerRegion(mainRegions, buttonX, cardY + 52, 218, 56, function () { startAdventure(location.id); });
      ...
      drawButton(targetCtx, buttonX, cardY + 116, 218, 46, miniLabel, canPlay ? "yellow" : "disabled", { small: true, disabled: !canPlay });
      if (canPlay) registerRegion(mainRegions, buttonX, cardY + 116, 218, 46, function () { openFlappyForLocation(location.id); });
    });
    drawCard(targetCtx, x + 28, progressY, w - 56, 254, THEME.paper);
    drawSectionHeader(targetCtx, x + 54, progressY + 20, "冒险进度", "当前冒险槽");
    drawMeter(targetCtx, x + 54, progressY + 144, w - 108, state.adventure.slots, state.adventure.maxSlots, ["#8adce9", "#d9cfab"], "槽位");
    const trip = currentAdventureTrip();
    if (trip) {
      const remaining = Math.max(0, Math.ceil((trip.endsAt - Date.now()) / 1000));
      const ready = remaining === 0;
      drawTextFitted(targetCtx, ready ? "当前冒险已结束，可以领取战利品。" : "正在探索： " + trip.locationName, x + 54, progressY + 192, w - 340, 20, THEME.ink, "600", "left", 14);
      drawTextFitted(targetCtx, ready ? "战利品已经准备好了。" : "剩余时间： " + formatClock(remaining), x + 54, progressY + 222, w - 340, 18, THEME.inkSoft, "500", "left", 14);
      drawButton(targetCtx, x + w - 250, progressY + 178, 168, 64, ready ? "领取战利品" : "冒险进行中", ready ? "yellow" : "disabled", { small: true, disabled: !ready });
      if (ready) registerRegion(mainRegions, x + w - 250, progressY + 178, 168, 64, collectAdventure);
    } else {
      drawTextFitted(targetCtx, "当前没有进行中的冒险。完成任务积累冒险槽后就能出发。", x + w / 2, progressY + 206, w - 180, 20, THEME.inkSoft, "500", "center", 14);
    }
    return y + sectionHeight;
  }
  ...
  function renderJournalPage(targetCtx, view, y) {
    ...
    drawSectionHeader(targetCtx, x + 30, historyStartY - 12, "历史统计", "本月冒险足迹");
    ...
    // 支持在浏览器里通过 HEATMAP_DEBUG_MONTH/HEATMAP_DEBUG_YEAR 调试月份
    const realToday = new Date();
    let year = realToday.getFullYear();
    let month = realToday.getMonth(); // 0-11
    if (typeof window !== "undefined" && window.HEATMAP_DEBUG_MONTH) {
      const debugMonth = Number(window.HEATMAP_DEBUG_MONTH) || 0; // 1-12
      if (debugMonth >= 1 && debugMonth <= 12) {
        month = debugMonth - 1;
        if (window.HEATMAP_DEBUG_YEAR) {
          const debugYear = Number(window.HEATMAP_DEBUG_YEAR);
          if (Number.isFinite(debugYear) && debugYear >= 1970 && debugYear <= 9999) {
            year = debugYear;
          }
        }
      }
    ...
    const todayDay = Math.min(realToday.getDate(), daysInMonth);
    ...
    for (let week = 0; week < totalWeeks; week += 1) {
      for (let col = 0; col < cols; col += 1) {
        ...
        const label = (month + 1).toString().padStart(2, "0") + "-" + day.toString().padStart(2, "0");
    ...
    function drawCodexPreviewBox(entryId, slotIndex, isPlus) {
      ...
      if (isPlus) {
        ...
        let sprite = null;
        let frameColor = null;
        if (parsed.kind === "scene" || parsed.kind === "hair" || parsed.kind === "top" || parsed.kind === "bottom" || parsed.kind === "gear" || parsed.kind === "accessory") {
  ...
  function renderToast(targetCtx, view) {
    ...
    lines.forEach(function (line, index) {
      drawText(targetCtx, line, x + 24, y + 22 + index * 22, 20, tone, "600");
    });
  }
  ...
  function renderFlappyModal(targetCtx, view) {
    ...
    // 更新逻辑（只在 playing 时）
    // 处理键盘请求（由 keydown 写入 modal._startRequested / modal._flapRequested）
    if (modal._startRequested) {
      modal._startRequested = false;
      if (modal.phase !== "select") {
        // 让点击区域的逻辑一致：在本帧触发一次“开始并起跳”
        modal._flapRequested = true;
        // 通过把 phase 留在 ready，由 flapStartIfNeeded 接管扣槽与重置
      }
    }
    ...
    // 空格触发：本帧立即执行开始/起跳（避免错过）
    if (modal._flapRequested) {
      modal._flapRequested = false;
      flapStartIfNeeded();
    }

    // 点击：只允许在游戏进行中起跳；开始/重开只能按空格
    registerRegion(overlayRegions, gameX, gameY, gameW, gameH, function () {
      if (modal.phase === "select") return;
      if (modal.phase === "playing") {
        flapStartIfNeeded();
      } else {
        setToast("按空格开始/重新挑战。", "info");
        if (currentView) renderOverlay(currentView); else renderApp();
      }
    ...
    if (modal.phase === "select") {
      ...
      tierOptions.forEach(function (opt, idx) {
        ...
        const line2H = 24;
        const lineGap = 6;
        const blockH = line1H + lineGap + line2H;
        const blockY = by + (bh - blockH) / 2;
        const centerX = bx + bw / 2;
        // 用中心点绘制，保证水平严格居中；字号仍按 maxWidth 自动缩小
        ...
        const line2 = "目标 " + opt.target + " 分 · 奖励 " + opt.bonusRolls + " 项";
        const line2Size = fitCanvasTextSize(line2, bw - 28, 20, "600", 14);
        drawText(targetCtx, line2, centerX, blockY + line1H + lineGap, line2Size, THEME.inkSoft, "600", "center");
      ...
      drawText(targetCtx, "选好后按空格开始（每局消耗冒险槽 " + (modal.slotCost || 0) + "）", gameX + gameW / 2, gameY + gameH / 2 + 96, 18, "#3a2b2b", "600", "center");
      ...
      if (modal.phase === "over") {
        ...
        drawText(targetCtx, "按空格重新挑战（会再次消耗冒险槽）", gameX + gameW / 2, gameY + gameH / 2 + 52, 16, "#3a2b2b", "500", "center");
      } else {
        drawText(targetCtx, "按空格开始", gameX + gameW / 2, gameY + gameH / 2 - 24, 34, "#3a2b2b", "800", "center");
    ...
    // 底部说明
    drawText(targetCtx, "点击或空格起跳 · ESC 关闭", innerX + 8, y + height - 30, 14, "#d8aa95", "500");
  ...
  function renderPomodoroModal(targetCtx, view) {
    ...
    overlayModalLayout = { type: "pomodoro", x: x, y: y, width: width, height: height, header: { x: x, y: y, width: width, height: headerH } };
    ...
    const oy = -scroll;
    drawCard(targetCtx, x + 26, y + 110 + oy, width - 52, 320, THEME.paper);
    drawSpriteFrame(targetCtx, getCharacterSprite(state.profile.appearance, 72), x + 120, y + 148 + oy, 210);
    drawPomodoroVsPixel(targetCtx, x + width / 2, y + 226 + oy, 70, THEME.ink);
    drawSpriteFrame(targetCtx, getBossSprite(currentBossTemplate().kind, 72), x + width - 332, y + 148 + oy, 210);
    const adventurerName = String((state.profile && state.profile.name) || HERO_ROLE || "冒险者").trim() || "冒险者";
    drawTextFitted(targetCtx, adventurerName + "，专注来打败怪物", x + width / 2, y + 360 + oy, width - 140, 24, THEME.inkSoft, "600", "center", 14);
  ...
  function renderCodexModal(targetCtx, view) {
    const modal = state.modal;
    const width = Math.min(1180, view.contentWidth - 60);
    const height = Math.min(750, view.logicalHeight - 80);
    const x = view.left + (view.contentWidth - width) / 2;
    const y = 40;
    const leftRatio = 0.6;
    const gap = 24;
    const leftW = Math.floor(width * leftRatio);
    const rightW = width - leftW - gap - 40;
    const headerH = 40;
    const bodyY = y + headerH + 20;
    const bodyH = height - headerH - 36;
    ...
    const filterW = 150;
    const filterH = 50;
    const filterX = closeX - filterW - 16;
    const filterY = y;
    ...
    const categories = [["all", "全部"], ["hair", "发型"], ["top", "上装"], ["bottom", "下装"], ["gear", "装备"], ["accessory", "配饰"], ["scene", "场景"], ["pet", "宠物"], ["boss", "Boss"]];
    ...
    const leftX = x + 24;
    const leftY = bodyY;
    const leftWInner = leftW;
    const leftHInner = bodyH;
    targetCtx.save();
    targetCtx.beginPath();
    ...
    const allEntries = (function () {
      ...
      // 初始条目：无条件加入列表
      INITIAL_CODEX_ITEMS.forEach(function (entry) {
        list.push({ id: codexKey(entry.kind, entry.key), kind: entry.kind, key: entry.key, name: entry.name, initial: true });
      });
    ...
    filtered.forEach(function (entry, index) {
      ...
      if (entry.initial) {
        // 初始条目需要自行生成预览图
        frameColor = itemRarityFrameColor({ rarity: "廉价" });
        if (entry.kind === "scene") sprite = getSceneSprite(entry.key, frameSize);
          ...
          const previewAppearance = {
            ...
            weapon: entry.kind === "gear" ? entry.key : "木剑",
            accessory: "无",
          };
      ...
      registerRegion(overlayRegions, cx, cy, cardW, cardH, function () {
    ...
    // 右侧详情
    const rightX = leftX + leftWInner + gap;
    const rightY = bodyY;
    drawCard(targetCtx, rightX, rightY, rightW, bodyH, THEME.paper);
    const selectedId = modal.selectedId;
    if (!selectedId) {
      drawParagraph(targetCtx, "在左侧选择一个条目，可以查看它的详细图鉴信息。", rightX + 24, rightY + 32, rightW - 48, 18, THEME.inkSoft, 24, { maxLines: 4 });
    } else {
      const parsed = (function () {
      ...
      if (isInitialEntry && codexEntry) {
        ...
        kindLabel = parsed.kind === "scene" ? "背景" : parsed.kind === "hair" ? "发型" : parsed.kind === "top" ? "上装" : parsed.kind === "bottom" ? "下装" : parsed.kind === "gear" ? "装备" : "物品";
        ...
        if (parsed.kind === "scene") sprite = getSceneSprite(parsed.key, 120);
          ...
          const previewAppearance = {
            ...
            weapon: parsed.kind === "gear" ? parsed.key : "木剑",
            accessory: "无",
          };
          sprite = getCharacterSprite(previewAppearance, 120);
        }
      } else if (parsed.kind === "scene" || parsed.kind === "hair" || parsed.kind === "top" || parsed.kind === "bottom" || parsed.kind === "gear" || parsed.kind === "accessory" || (parsed.kind === "pet" && catalogItemById(parsed.key))) {
        const item = catalogItemById(parsed.key);
        if (item) {
          title = item.name;
      ...
      // 图鉴详情排版：大图逻辑
      const detailImageSize = 280;
      const detailImageX = rightX + (rightW - detailImageSize) / 2;
      const detailImageY = rightY + 28;
      // 宠物：解锁后显示对应阶段大图，未解锁显示宝箱；其他类型未解锁时显示宝箱
      let detailSprite;
      if (parsed.kind === "pet") {
        detailSprite = isUnlocked && sprite ? sprite : getTreasureSprite(detailImageSize);
      } else {
        detailSprite = isUnlocked && sprite ? sprite : getTreasureSprite(detailImageSize);
      }
      drawSpriteFrame(targetCtx, detailSprite, detailImageX, detailImageY, detailImageSize, null);
      // 物品名称居中显示在大图下方（随大图下移），整体向右偏移约 173 像素
      ...
      // 简介单独一段显示，使用类似心情描述的排版，但字号更大，并与下方信息留出较大间距
      const rawDescText = (desc && String(desc).trim()) || "暂无简介。";
      // 宠物图鉴：即便未解锁也展示真实简介；其他类型未解锁时用“未知”
      ...
      // 类型 / 等级：始终显示真实信息；来源与解锁时间在未解锁时用“未解锁”占位（初始条目已在上方写死）
      drawMetaRow("类型", kindLabel || "未知");
      if (parsed.kind === "boss") drawMetaRow("等级", levelText || "—");
      else drawMetaRow("等级", levelText || "普通");
      if (isInitialEntry) {
        drawMetaRow("来源", "初始获得");
  ...
  function renderAchievementsModal(targetCtx, view) {
    ...
    if (ach) {
      const frameSize = 120;
      const frameX = rightX + 34;
      const frameY = rightY + 32;
      drawAchievementIcon(targetCtx, frameX, frameY, frameSize, ach, unlocked, true);
      const titleX = frameX + frameSize + 24;
      drawTextFitted(targetCtx, ach.name, titleX, frameY + 10, rightW - (titleX - rightX) - 30, 26, THEME.ink, "700", "left", 18);
      drawParagraph(targetCtx, ach.description, titleX, frameY + 48, rightW - (titleX - rightX) - 30, 16, THEME.inkSoft, 24, { maxLines: 3 });
      const infoY = frameY + frameSize + 34;
      drawText(targetCtx, "达成条件", rightX + 34, infoY, 16, THEME.inkSoft, "600");
      drawParagraph(targetCtx, ach.condition, rightX + 34, infoY + 18, rightW - 68, 16, THEME.ink, 24, { maxLines: 3 });
      const rewardY = infoY + 72;
      drawText(targetCtx, "奖励", rightX + 34, rewardY, 16, THEME.inkSoft, "600");
      drawParagraph(targetCtx, ach.rewardText || "—", rightX + 34, rewardY + 18, rightW - 68, 16, THEME.ink, 24, { maxLines: 2 });
      const timeY = rewardY + 66;
      drawText(targetCtx, "达成时间", rightX + 34, timeY, 16, THEME.inkSoft, "600");
      const timeText = unlockedInfo && unlockedInfo.unlockedAt
        ? dayKey(new Date(unlockedInfo.unlockedAt))
        : "未解锁";
      drawText(targetCtx, timeText, rightX + 34, timeY + 22, 16, unlocked ? THEME.ink : THEME.inkSoft, "500");

      // 领取奖励按钮
      const btnY = timeY + 80;
      const btnX = rightX + 34;
      const btnW = 160;
      const btnH = 50;
      if (!unlocked) {
  ...
  function renderSettingsModal(targetCtx, view) {
    ...
    const themes = ["wood", "sunset", "midnight", "maple", "sage", "plum", "lavender", "slate", "sakura"]
      .map(function (key) { return UI_THEME_PRESETS[key]; })
      .filter(function (t) { return !!t; });
    const cols = width > 940 ? 3 : 2;
    const gap = 18;
    const cardW = (width - 48 - gap * (cols - 1)) / cols;
    const cardH = cols === 3 ? 162 : 144;
    const rows = Math.ceil(themes.length / cols);
    const baseHeight = activeTab === "theme" ? 190 + rows * cardH + (rows - 1) * gap : 190 + 3 * 130 + 2 * 18;
    ...
    if (activeTab === "theme") {
      ...
      // 导出存档
      drawCard(targetCtx, cardX, cardY, cardWStorage, cardHStorage, THEME.paperSoft);
      ...
      let btnY = cardY + cardHStorage / 2 - btnH / 2;
      ...
      // 导入存档
      const importCardY = cardY + cardHStorage + 18;
  ...
  function renderEditorModal(targetCtx, view) {
    ...
    const viewportX = x + 24;
    const viewportY = y + 106;
    const viewportW = width - 48;
    const viewportH = height - 132;
    const controlX = x + leftW + 36;
    const controlW = width - leftW - 60;
    const dual = controlW > 680;
    const fieldW = dual ? (controlW - 24) / 2 : controlW;
    const nameRowY = y + 122;
    const firstSelectorRowY = nameRowY + 104;
    const secondRowY = firstSelectorRowY + (dual ? 104 : 208);
    const thirdRowY = secondRowY + (dual ? 104 : 208);
    const fourthRowY = thirdRowY + (dual ? 104 : 208);
    let contentBottom = Math.max(y + (compactEditor ? 676 : 724), fourthRowY + (dual ? 120 : 228) + 108 * 6);
    const leftCardHeight = compactEditor ? 460 : 500;
    const maxScroll = Math.max(0, contentBottom - (viewportY + viewportH) + 24);
    const scroll = clamp(state.modal.scroll || 0, 0, maxScroll);
    state.modal.scroll = scroll;
    state.modal.maxScroll = maxScroll;

    targetCtx.save();
    targetCtx.beginPath();
    targetCtx.rect(viewportX, viewportY, viewportW, viewportH);
    targetCtx.clip();

    drawCard(targetCtx, x + 24, y + 106, leftW, Math.max(leftCardHeight, viewportH), THEME.paper);
    drawSpriteFrame(targetCtx, getCharacterSprite(state.profile.appearance, 96), x + (compactEditor ? 54 : 56), y + 136, previewSize);
    drawSpriteFrame(targetCtx, getPetSprite(currentPet(), 48, petDisplayFormValue(currentPet())), x + (compactEditor ? 136 : 154), y + (compactEditor ? 426 : 458), petPreviewSize);

    const contentShift = -scroll;
    drawInputField(targetCtx, controlX, nameRowY + contentShift, controlW, 68, "角色名称", state.profile.name || HERO_ROLE, "例如：像素冒险家", "profileName", false);

    drawSelectorField(targetCtx, controlX, firstSelectorRowY + contentShift, fieldW, 68, "\u80a4\u8272", state.profile.appearance.skin, function () { cycleAppearance(COLOR_OPTIONS.skin.map(function (entry) { return entry[0]; }), "skin"); });
    drawSelectorField(targetCtx, controlX + (dual ? fieldW + 24 : 0), firstSelectorRowY + (dual ? 0 : 104) + contentShift, fieldW, 68, "\u53d1\u8272", state.profile.appearance.hairColor, function () { cycleAppearance(COLOR_OPTIONS.hairColor.map(function (entry) { return entry[0]; }), "hairColor"); });
    drawSelectorField(targetCtx, controlX, secondRowY + contentShift, fieldW, 68, "\u77b3\u8272", state.profile.appearance.eyeColor, function () { cycleAppearance(COLOR_OPTIONS.eyeColor.map(function (entry) { return entry[0]; }), "eyeColor"); });
    drawSelectorField(targetCtx, controlX + (dual ? fieldW + 24 : 0), secondRowY + (dual ? 0 : 104) + contentShift, fieldW, 68, "\u773c\u775b", state.profile.appearance.eyeStyle, function () { cycleAppearance(EYE_STYLES, "eyeStyle"); });
    drawSelectorField(targetCtx, controlX, thirdRowY + contentShift, fieldW, 68, "\u5634\u5df4", state.profile.appearance.mouthStyle, function () { cycleAppearance(MOUTH_STYLES, "mouthStyle"); });
    drawSelectorField(targetCtx, controlX + (dual ? fieldW + 24 : 0), thirdRowY + (dual ? 0 : 104) + contentShift, fieldW, 68, "\u4e0a\u88c5\u989c\u8272", state.profile.appearance.topColor, function () { cycleAppearance(COLOR_OPTIONS.topColor.map(function (entry) { return entry[0]; }), "topColor"); });
    drawSelectorField(targetCtx, controlX, fourthRowY + contentShift, fieldW, 68, "\u4e0b\u88c5\u989c\u8272", state.profile.appearance.bottomColor, function () { cycleAppearance(COLOR_OPTIONS.bottomColor.map(function (entry) { return entry[0]; }), "bottomColor"); });
    drawSelectorField(targetCtx, controlX + (dual ? fieldW + 24 : 0), fourthRowY + (dual ? 0 : 104) + contentShift, fieldW, 68, "\u5f53\u524d\u53d1\u578b", state.profile.appearance.hairStyle, null);
    let rowY = fourthRowY + (dual ? 120 : 228);
    drawEditorChoiceRow(targetCtx, controlX, rowY + contentShift, controlW, "backgrounds", "已拥有背景", state.collection.backgrounds.map(function (value) { return { label: value, width: compactEditor ? 120 : 170, active: state.profile.appearance.background === value, onClick: function () { equipAppearanceFromCollection("background", value); } }; }));
    rowY += 108;
    drawEditorChoiceRow(targetCtx, controlX, rowY + contentShift, controlW, "hair", "已拥有发型", state.collection.hairStyles.map(function (value) { return { label: value, width: compactEditor ? 100 : 140, active: state.profile.appearance.hairStyle === value, onClick: function () { equipAppearanceFromCollection("hairStyle", value); } }; }));
    rowY += 108;
    drawEditorChoiceRow(targetCtx, controlX, rowY + contentShift, controlW, "tops", "已拥有上装", state.collection.topStyles.map(function (value) { return { label: value, width: compactEditor ? 120 : 170, active: state.profile.appearance.topStyle === value, onClick: function () { equipAppearanceFromCollection("topStyle", value); } }; }));
    rowY += 108;
    drawEditorChoiceRow(targetCtx, controlX, rowY + contentShift, controlW, "bottoms", "已拥有下装", state.collection.bottomStyles.map(function (value) { return { label: value, width: compactEditor ? 120 : 170, active: state.profile.appearance.bottomStyle === value, onClick: function () { equipAppearanceFromCollection("bottomStyle", value); } }; }));
    rowY += 108;
    drawEditorChoiceRow(targetCtx, controlX, rowY + contentShift, controlW, "weapons", "已拥有装备", state.collection.weapons.map(function (value) { return { label: value, width: compactEditor ? 120 : 160, active: state.profile.appearance.weapon === value, onClick: function () { equipAppearanceFromCollection("weapon", value); } }; }));
    rowY += 108;
    drawEditorChoiceRow(targetCtx, controlX, rowY + contentShift, controlW, "accessories", "已拥有配饰", state.collection.accessories.map(function (value) { return { label: value, width: compactEditor ? 120 : 170, active: currentAccessories(state.profile.appearance).includes(value), onClick: function () { equipAppearanceFromCollection("accessory", value); } }; }));
    targetCtx.restore();

    if (maxScroll > 0) {
      fillRect(targetCtx, x + width - 28, viewportY, 8, viewportH, "#5c342d");
      const thumbH = Math.max(60, viewportH * (viewportH / (viewportH + maxScroll)));
      const thumbY = viewportY + ((viewportH - thumbH) * (scroll / maxScroll));
      fillRect(targetCtx, x + width - 30, thumbY, 12, thumbH, THEME.yellow);
      targetCtx.strokeStyle = THEME.black;
      targetCtx.lineWidth = 2;
      targetCtx.strokeRect(x + width - 30, thumbY, 12, thumbH);
      drawText(targetCtx, "\u6eda\u8f6e\u53ef\u4e0a\u4e0b\u6ed1\u52a8", x + width - 178, y + height - 30, 14, "#d8aa95", "500");
    }
  }
  ...
  function handleCanvasMove(event, regions, canvas) {
    ...
    const nextTooltip = region && region.tooltip ? { text: region.tooltip, cursorX: viewportPoint.x, cursorY: viewportPoint.y } : null;
    const ax = nextTooltip ? (nextTooltip.cursorX !== undefined ? nextTooltip.cursorX : nextTooltip.x) : 0;
    const ay = nextTooltip ? (nextTooltip.cursorY !== undefined ? nextTooltip.cursorY : nextTooltip.y) : 0;
    const bx = hoverTooltip ? (hoverTooltip.cursorX !== undefined ? hoverTooltip.cursorX : hoverTooltip.x) : 0;
    const by = hoverTooltip ? (hoverTooltip.cursorY !== undefined ? hoverTooltip.cursorY : hoverTooltip.y) : 0;
    const tooltipChanged = (!hoverTooltip && nextTooltip) || (hoverTooltip && !nextTooltip) || (hoverTooltip && nextTooltip && (hoverTooltip.text !== nextTooltip.text || Math.abs(ax - bx) > 2 || Math.abs(ay - by) > 2));
  ...
  mainCanvas.addEventListener("pointerleave", function () { hoverTooltip = null; hoverCursor = "default"; mainCanvas.style.cursor = "default"; overlayCanvas.style.cursor = "default"; if (currentView) renderOverlay(currentView); });
  overlayCanvas.addEventListener("pointerleave", function () { hoverTooltip = null; hoverCursor = "default"; mainCanvas.style.cursor = "default"; overlayCanvas.style.cursor = "default"; if (currentView) renderOverlay(currentView); });
  ...
  overlayCanvas.addEventListener("wheel", function (event) {
    ...
    if (state.modal.type === "editor") {
      event.preventDefault();
      scrollEditorModal(event.deltaY > 0 ? 72 : -72);
      return;
    }
    if (state.modal.type === "pomodoro" || state.modal.type === "codex" || state.modal.type === "achievements") {
      const maxScroll = Math.max(0, state.modal.maxScroll || 0);
      if (maxScroll <= 0) return;
      event.preventDefault();
      const next = clamp((state.modal.scroll || 0) + (event.deltaY > 0 ? 72 : -72), 0, maxScroll);
      if (next === (state.modal.scroll || 0)) return;
